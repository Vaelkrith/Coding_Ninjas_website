...
export const metadata: Metadata = {
  ...
  description:
    "Meet Darlene Robertson, Engineer at Synkora, building the future of collaborative workspaces.",
};
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-lg leading-relaxed">
              Building the future of collaborative workspaces. Darlene is
              passionate about creating scalable, performant solutions that
              enable teams to collaborate seamlessly in real-time.
            </p>
          </div>
        </div>
      </div>
