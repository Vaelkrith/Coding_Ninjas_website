...
export const metadata: Metadata = {
  ...
  description:
    "Meet Kristin Watson, Marketing Lead at Synkora, driving growth and connecting teams worldwide.",
};
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-lg leading-relaxed">
              Driving growth and connecting teams worldwide. Kristin specializes
              in building brand awareness and creating meaningful connections
              between Synkora and our global community.
            </p>
          </div>
        </div>
      </div>
