...
export const metadata: Metadata = {
  ...
  description:
    "Meet Cameron Williamson, Designer at Synkora, crafting intuitive experiences for modern teams.",
};
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-lg leading-relaxed">
              Crafting intuitive experiences for modern teams. Cameron focuses
              on creating beautiful, user-friendly interfaces that make complex
              workflows feel simple and enjoyable.
            </p>
          </div>
        </div>
      </div>
